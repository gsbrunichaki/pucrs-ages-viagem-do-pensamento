...
export default function TripFeedback({ route, navigation }) {
          ...
          {autoAnalysis ? (
            <View style={style.feedback}>
              <View style={style.positiveBox}>
                <Text style={style.feedbackText}>
                  Parabéns! Foi legal para você esta viagem do pensamento.
                  Lembre-se de ter bons pensamentos, emoções confortáveis e agir
                  com cuidado.
                </Text>
              </View>
              <Button
                full
                rounded
                style={(style.button, { marginHorizontal: 60 })}
                onPress={(_) => navigation.navigate("Home")}
                title="Clique aqui para voltar ao menu inicial"
              >
            ...
            <View style={style.feedback}>
              <View style={style.negativeBox}>
                <Text style={style.feedbackText}>
                  Poxa... não foi desta vez que a viagem do pensamento foi
                  legal. Lembre-se de ter bons pensamentos, emoções confortáveis
                  e agir com cuidado.
                </Text>
              </View>
              ...
              <View style={style.buttonGroup}>
                <Button
                  ...
                  title="Clique aqui para reiniciar a viagem"
                >
